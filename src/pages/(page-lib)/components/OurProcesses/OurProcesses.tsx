    ...
    <section id="production" className="mt-10 bg-slate-200 py-24">
      <div className="m-5 justify-around md:m-10 md:flex lg:px-8 ">
        ...
        <div className="m-5 md:m-10">
          <h1 className="max-w-3xl font-sans text-5xl font-semibold leading-tight md:text-6xl md:leading-snug">
          ...
          <p className="mt-10 max-w-3xl text-left font-sans text-xl leading-10 text-gray-600">
            ...
            calidad y pureza. Desde la selección de la materia prima, en este caso, la yuca, hasta
            el envasado y distribución del producto final, cada etapa del proceso está
            cuidadosamente controlada y monitoreada por expertos en la materia.
          </p>
